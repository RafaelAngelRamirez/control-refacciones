...
//        //COLOCAMOS EL PANEL NUEVO.
        JOptionPane.showMessageDialog(null, "estamos aqui en el jpanelActual");
        this.contenedorParaPaneles.setViewportView(this.getCoordinador().getDialogoEmpleadoAgregar());
