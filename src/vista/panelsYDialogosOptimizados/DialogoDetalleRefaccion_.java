 ...
 * @author Particular
 */
public class DialogoDetalleRefaccion_ extends JDialog {
    ...
    public DialogoDetalleRefaccion_() {
        initComponents();
    }
...
//        setModal(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoDetalleRefaccion_.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoDetalleRefaccion_ dialog = new DialogoDetalleRefaccion_();
