 ...
 * @author Particular
 */
public class DialogoAgregarMaquinaModelo_ extends JDialog {
     ...
     */
    public DialogoAgregarMaquinaModelo_() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoAgregarMaquinaModelo_.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoAgregarMaquinaModelo_ dialog = new DialogoAgregarMaquinaModelo_();
